...
import type {
  CustomerType, Customer, Category, Product, ProductType,
  Combo, ComboDetail, Warehouse, Employee, Role,
  EmployeeRole, ShipCompany, Invoice, Order, OrderDetail,
  InvoiceDetail, PaymentMethod, Payment, ReturnPolicy, OrderReturn,
  ReturnDetail, DetailInventory, Notification, RequestForm, RequestDetail,
  TransferTicket, TransferTicketDetail, ImportReceipt, ImportReceiptDetail,
  ExportReceipt, ExportReceiptDetail, CountSheet, CountSheetDetail,
  Discount, ListDiscount, Feedback
} from "./types";
...
export const api = {
  ...
  customerTypes: {
    ...
    create: (data: CustomerType) => apiClient.post<CustomerType>("/customer-types", data),
    update: (id: number, data: CustomerType) => apiClient.put<CustomerType>(`/customer-types/${id}`, data),
  ...
  customers: {
    ...
    update: (id: number, data: Customer) => apiClient.put<Customer>(`/customers/${id}`, data),
  ...
  categories: {
    ...
    update: (id: number, data: Category) => apiClient.put<Category>(`/categories/${id}`, data),
  ...
  products: {
    ...
    update: (id: number, data: Product) => apiClient.put<Product>(`/products/${id}`, data),
  ...
  productTypes: {
    ...
    create: (data: ProductType) => apiClient.post<ProductType>("/product-types", data),
    update: (id: number, data: ProductType) => apiClient.put<ProductType>(`/product-types/${id}`, data),
  ...
  combos: {
    ...
    update: (id: number, data: Combo) => apiClient.put<Combo>(`/combos/${id}`, data),
  ...
  comboDetails: {
    ...
    create: (data: ComboDetail) => apiClient.post<ComboDetail>("/combo-details", data),
    update: (id: number, data: ComboDetail) => apiClient.put<ComboDetail>(`/combo-details/${id}`, data),
  ...
  warehouses: {
    ...
    update: (id: number, data: Warehouse) => apiClient.put<Warehouse>(`/warehouses/${id}`, data),
  ...
  employees: {
    ...
    update: (id: number, data: Employee) => apiClient.put<Employee>(`/employees/${id}`, data),
  ...
  roles: {
    ...
    update: (id: number, data: Role) => apiClient.put<Role>(`/roles/${id}`, data),
  ...
  employeeRoles: {
    ...
    create: (data: EmployeeRole) => apiClient.post<EmployeeRole>("/employee-roles", data),
    update: (id: number, data: EmployeeRole) => apiClient.put<EmployeeRole>(`/employee-roles/${id}`, data),
  ...
  shipCompanies: {
    ...
    create: (data: ShipCompany) => apiClient.post<ShipCompany>("/ship-companies", data),
    update: (id: number, data: ShipCompany) => apiClient.put<ShipCompany>(`/ship-companies/${id}`, data),
  ...
  invoices: {
    ...
    update: (id: number, data: Invoice) => apiClient.put<Invoice>(`/invoices/${id}`, data),
  ...
  orders: {
    ...
    update: (id: number, data: Order) => apiClient.put<Order>(`/orders/${id}`, data),
  ...
  orderDetails: {
    ...
    create: (data: OrderDetail) => apiClient.post<OrderDetail>("/order-details", data),
    update: (id: number, data: OrderDetail) => apiClient.put<OrderDetail>(`/order-details/${id}`, data),
  ...
  invoiceDetails: {
    ...
    create: (data: InvoiceDetail) => apiClient.post<InvoiceDetail>("/invoice-details", data),
    update: (id: number, data: InvoiceDetail) => apiClient.put<InvoiceDetail>(`/invoice-details/${id}`, data),
  ...
  paymentMethods: {
    ...
    create: (data: PaymentMethod) => apiClient.post<PaymentMethod>("/payment-methods", data),
    update: (id: number, data: PaymentMethod) => apiClient.put<PaymentMethod>(`/payment-methods/${id}`, data),
  ...
  returnPolicies: {
    ...
    create: (data: ReturnPolicy) => apiClient.post<ReturnPolicy>("/return-policies", data),
    update: (id: number, data: ReturnPolicy) => apiClient.put<ReturnPolicy>(`/return-policies/${id}`, data),
  ...
  orderReturns: {
    ...
    create: (data: OrderReturn) => apiClient.post<OrderReturn>("/order-returns", data),
    update: (id: number, data: OrderReturn) => apiClient.put<OrderReturn>(`/order-returns/${id}`, data),
  ...
  returnDetails: {
    ...
    create: (data: ReturnDetail) => apiClient.post<ReturnDetail>("/return-details", data),
    update: (id: number, data: ReturnDetail) => apiClient.put<ReturnDetail>(`/return-details/${id}`, data),
  ...
  detailInventories: {
    ...
    get: (id: number) => apiClient.get<DetailInventory>(`/detail-inventories/${id}`),
    create: (data: DetailInventory) => apiClient.post<DetailInventory>("/detail-inventories", data),
    update: (id: number, data: DetailInventory) => apiClient.put<DetailInventory>(`/detail-inventories/${id}`, data),
  ...
  notifications: {
    ...
    create: (data: Notification) => apiClient.post<Notification>("/notifications", data),
    update: (id: number, data: Notification) => apiClient.put<Notification>(`/notifications/${id}`, data),
  ...
  requestForms: {
    ...
    create: (data: RequestForm) => apiClient.post<RequestForm>("/request-forms", data),
    update: (id: number, data: RequestForm) => apiClient.put<RequestForm>(`/request-forms/${id}`, data),
  ...
  requestDetails: {
    ...
    create: (data: RequestDetail) => apiClient.post<RequestDetail>("/request-details", data),
    update: (id: number, data: RequestDetail) => apiClient.put<RequestDetail>(`/request-details/${id}`, data),
  ...
  transferTickets: {
    ...
    get: (id: number) => apiClient.get<TransferTicket>(`/transfer-tickets/${id}`),
    create: (data: TransferTicket) => apiClient.post<TransferTicket>("/transfer-tickets", data),
    update: (id: number, data: TransferTicket) => apiClient.put<TransferTicket>(`/transfer-tickets/${id}`, data),
    delete: (id: number) => apiClient.delete<void>(`/transfer-tickets/${id}`),
  },

  // 27. TRANSFERTICKETDETAIL TABLE
  transferTicketDetails: {
    list: () => apiClient.get<TransferTicketDetail[]>("/transfer-ticket-details"),
    get: (id: number) => apiClient.get<TransferTicketDetail>(`/transfer-ticket-details/${id}`),
    create: (data: TransferTicketDetail) => apiClient.post<TransferTicketDetail>("/transfer-ticket-details", data),
    update: (id: number, data: TransferTicketDetail) => apiClient.put<TransferTicketDetail>(`/transfer-ticket-details/${id}`, data),
    delete: (id: number) => apiClient.delete<void>(`/transfer-ticket-details/${id}`),
  },
  ...
  importReceipts: {
    ...
    create: (data: ImportReceipt) => apiClient.post<ImportReceipt>("/import-receipts", data),
    update: (id: number, data: ImportReceipt) => apiClient.put<ImportReceipt>(`/import-receipts/${id}`, data),
  ...
  importReceiptDetails: {
    ...
    get: (id: number) => apiClient.get<ImportReceiptDetail>(`/import-receipt-details/${id}`),
    create: (data: ImportReceiptDetail) => apiClient.post<ImportReceiptDetail>("/import-receipt-details", data),
    update: (id: number, data: ImportReceiptDetail) => apiClient.put<ImportReceiptDetail>(`/import-receipt-details/${id}`, data),
    delete: (id: number) => apiClient.delete<void>(`/import-receipt-details/${id}`),
  },
  ...
  exportReceipts: {
    ...
    create: (data: ExportReceipt) => apiClient.post<ExportReceipt>("/export-receipts", data),
    update: (id: number, data: ExportReceipt) => apiClient.put<ExportReceipt>(`/export-receipts/${id}`, data),
  ...
  exportReceiptDetails: {
    ...
    get: (id: number) => apiClient.get<ExportReceiptDetail>(`/export-receipt-details/${id}`),
    create: (data: ExportReceiptDetail) => apiClient.post<ExportReceiptDetail>("/export-receipt-details", data),
    update: (id: number, data: ExportReceiptDetail) => apiClient.put<ExportReceiptDetail>(`/export-receipt-details/${id}`, data),
    delete: (id: number) => apiClient.delete<void>(`/export-receipt-details/${id}`),
  },
  ...
  countSheets: {
    ...
    create: (data: CountSheet) => apiClient.post<CountSheet>("/count-sheets", data),
    update: (id: number, data: CountSheet) => apiClient.put<CountSheet>(`/count-sheets/${id}`, data),
  ...
  countSheetDetails: {
    ...
    get: (id: number) => apiClient.get<CountSheetDetail>(`/count-sheet-details/${id}`),
    create: (data: CountSheetDetail) => apiClient.post<CountSheetDetail>("/count-sheet-details", data),
    update: (id: number, data: CountSheetDetail) => apiClient.put<CountSheetDetail>(`/count-sheet-details/${id}`, data),
    delete: (id: number) => apiClient.delete<void>(`/count-sheet-details/${id}`),
  },
  ...
  discounts: {
    ...
    update: (id: number, data: Discount) => apiClient.put<Discount>(`/discounts/${id}`, data),
  ...
  listDiscounts: {
    ...
    create: (data: ListDiscount) => apiClient.post<ListDiscount>("/list-discounts", data),
    update: (id: number, data: ListDiscount) => apiClient.put<ListDiscount>(`/list-discounts/${id}`, data),
  ...
  feedbacks: {
    ...
    update: (id: number, data: Feedback) => apiClient.put<Feedback>(`/feedbacks/${id}`, data),
