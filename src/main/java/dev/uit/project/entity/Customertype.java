...
public class Customertype {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CUSTOMERTYPE_id_gen")
    @SequenceGenerator(name = "CUSTOMERTYPE_id_gen", sequenceName = "CUSTOMER_TYPE_SEQ", allocationSize = 1)
