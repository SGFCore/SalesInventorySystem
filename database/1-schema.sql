...
CREATE TABLE LISTDISCOUNT (
    ...
    CONSTRAINT fk_ld_order FOREIGN KEY (OrderID) REFERENCES ORDERS(OrderID),
...
ALTER TABLE ORDERS ADD CONSTRAINT fk_order_exportreceipt FOREIGN KEY (ExportReceiptID) REFERENCES EXPORTRECEIPT(ExportReceiptID);
